    ...
    public class GetCountOfPhoneCallActivity:IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                //Query all cases associated to given account
                ...
                {
                    //Query All Phone call activity( created in past 90 days) associated to each cases of given account 
               ...
               //Update Phone Count on Account
                Entity ObjAccount = new Entity("account", context.PrimaryEntityId);
                ObjAccount[AccountUtility.PhoneCount] = PhoneCount;
                service.Update(ObjAccount);


            }
            catch (Exception ex) { throw new InvalidPluginExecutionException("Exception occured in GetCountOfPhoneCallActivity Plugin" + ex.Message); }
